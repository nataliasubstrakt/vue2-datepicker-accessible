(function (global, factory) {
  ...
  var script = {
    ...
    methods: {
      afterAnimateIn: function afterAnimateIn() {
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c(
      'transition',
      {
        ...
        on: {
          'after-enter': _vm.afterAnimateIn,
        },
      },
      [
        _vm.visible
  ...
  var script$2 = {
    ...
    methods: {
      ...
      handleTab: function handleTab(cell, row, column) {
        var currentRefName = this.handleRefName(cell, row, column);
        var lastRef = this.refsArray[this.refsArray.length - 1];
      ...
      handleArrowUp: function handleArrowUp(cell, row, column) {
        var _this$$refs$refName;
        if (row === 0) {
          return;
        }
        var refName = this.handleRefName(cell, row - 1, column);
        var ref =
          (_this$$refs$refName = this.$refs[refName]) === null || _this$$refs$refName === void 0
            ? void 0
      ...
      handleArrowDown: function handleArrowDown(cell, row, column) {
        var _this$$refs$refName2;
        if (row === this.dates.length - 1) {
          return;
        }
        var refName = this.handleRefName(cell, row + 1, column);
        var ref =
          (_this$$refs$refName2 = this.$refs[refName]) === null || _this$$refs$refName2 === void 0
            ? void 0
            : _this$$refs$refName2[0];
        if (ref) {
          ref.focus();
        }
      },
      handleArrowLeft: function handleArrowLeft(cell, row, column) {
        var currentRefName = this.handleRefName(cell, row, column);
        var firstRef = this.refsArray[0];
        if (currentRefName !== firstRef[0]) {
          var _this$$refs$refName3;
          var refName = this.handleRefName(cell, row, column - 1);
          var ref =
            (_this$$refs$refName3 = this.$refs[refName]) === null || _this$$refs$refName3 === void 0
              ? void 0
              : _this$$refs$refName3[0];
          if (ref) {
            ref.focus();
          }
        } else if (this.range) {
          ...
          var lastRow = this.dates[this.dates.length - 1];
          var cellName = '#range-date-'
            .concat(index, '-cell-')
            .concat(this.dates.length - 1, '-')
            .concat(lastRow.length - 1);
          var cellElement = document.querySelector(cellName);
          if (cellElement) {
            cellElement.focus();
          }
        }
      },
      handleArrowRight: function handleArrowRight(cell, row, column) {
        var currentRefName = this.handleRefName(cell, row, column);
        var lastRef = this.refsArray[this.refsArray.length - 1];
        if (currentRefName !== lastRef[0]) {
          var _this$$refs$refName4;
          var refName = this.handleRefName(cell, row, column + 1);
          var ref =
            (_this$$refs$refName4 = this.$refs[refName]) === null || _this$$refs$refName4 === void 0
              ? void 0
              : _this$$refs$refName4[0];
          if (ref) {
            ref.focus();
          }
        } else if (this.range) {
          ...
          var cellName = '#range-date-'.concat(index, '-cell-0-0');
          var cellElement = document.querySelector(cellName);
          if (cellElement) {
            cellElement.focus();
          }
      ...
      handleRefName: function handleRefName(cellDate, row, col) {
        if (!this.isDisabled(cellDate)) {
          if (this.range) {
            return 'range-date-'.concat(this.rangeIndex, '-cell-').concat(row, '-').concat(col);
          }
          return 'date-cell-'.concat(row, '-').concat(col);
        }
        return undefined;
      },
      handleId: function handleId(row, col) {
        if (this.range) {
          return 'range-date-'.concat(this.rangeIndex, '-cell-').concat(row, '-').concat(col);
        }
        return undefined;
      },
      handleTabIndex: function handleTabIndex(cellDate) {
        var response = this.isDisabled(cellDate);
        return response ? -1 : 0;
      },
    },
  };
        ...
        _c(
          ...
          [
            _c('icon-button', {
              attrs: {
                type: 'double-left',
                'aria-label': _vm.locale.prevYear,
            ...
            _c('icon-button', {
              attrs: {
                type: 'left',
                'aria-label': _vm.locale.prevMonth,
            ...
            _c('icon-button', {
              attrs: {
                type: 'right',
                'aria-label': _vm.locale.nextMonth,
            ...
            _c('icon-button', {
              attrs: {
                type: 'double-right',
                'aria-label': _vm.locale.nextYear,
                  ...
                  'tbody',
                  {
                    on: {
                      ...
                      keydown: function keydown($event) {
                        ...
                        return _vm.handleCellClick.apply(null, arguments);
                      },
                    },
                  },
                      ...
                      [
                        ...
                        _vm._l(row, function (cell, j) {
                          return _c(
                            ...
                            {
                              key: j,
                              ref: _vm.handleRefName(cell, i, j),
                              refInFor: true,
                              staticClass: 'cell',
                              ...
                              attrs: {
                                ...
                                role: 'button',
                                'data-row-col': i + ',' + j,
                                disabled: _vm.isDisabled(cell),
                                tabindex: _vm.handleTabIndex(cell),
                              ...
                              on: {
                                ...
                                keydown: [
                                  function ($event) {
                                    ...
                                    return _vm.handleArrowUp(cell, i, j);
                                  },
                                  function ($event) {
                                    if (
                                      !$event.type.indexOf('key') &&
                                    ...
                                    $event.preventDefault();
                                    return _vm.handleArrowDown(cell, i, j);
                                  },
                                  function ($event) {
                                    if (
                                      !$event.type.indexOf('key') &&
                                    ...
                                    $event.preventDefault();
                                    return _vm.handleArrowLeft(cell, i, j);
                                  },
                                  function ($event) {
                                    if (
                                      !$event.type.indexOf('key') &&
                                    ...
                                    $event.preventDefault();
                                    return _vm.handleArrowRight(cell, i, j);
                                  },
                                  function ($event) {
                                    if (
                                      !$event.type.indexOf('key') &&
  ...
  var script$3 = {
    ...
    methods: {
      ...
      handleRefName: function handleRefName(cellDate, row, col) {
        var date = createDate$1(cellDate, 0);
        if (!this.isDisabled(date)) {
          return 'year-cell-'.concat(row, '-').concat(col);
        }
        return undefined;
      },
      handleTabIndex: function handleTabIndex(cellDate) {
      ...
      if (panel === 'year') {
        return h(__vue_component__$7, {
          ...
          on: {
            ...
            tableclose: this.handleTableclose,
          },
        });
      }
      if (panel === 'month') {
  ...
  var script$6 = {
    ...
    methods: {
      ...
      handleArrowLeft: function handleArrowLeft(col, row) {
        var _this$$refs;
        if (col <= 0) {
          return;
        }
        var ref =
          (_this$$refs = this.$refs['item-'.concat(col - 1, '-').concat(row)]) === null ||
          _this$$refs === void 0
            ? void 0
            : _this$$refs[0];
        if (ref) {
      ...
      handleArrowRight: function handleArrowRight(col, row) {
        var _this$$refs2;
        if (col >= 2) {
          return;
        }
        var ref =
          (_this$$refs2 = this.$refs['item-'.concat(col + 1, '-').concat(row)]) === null ||
          _this$$refs2 === void 0
            ? void 0
            : _this$$refs2[0];
        if (ref) {
              ...
              _vm._l(col.list, function (item, j) {
                return _c(
                  'li',
                  {
                    ...
                    attrs: {
                      tabindex: _vm.isDisabledTime(item.value, col.type) ? '-1' : '0',
                      'data-index': j,
                    },
                    on: {
                      keydown: [
                        function ($event) {
                          ...
                          $event.preventDefault();
                          return _vm.handleArrowLeft(i, j);
                        },
                        function ($event) {
                          if (
                            !$event.type.indexOf('key') &&
                          ...
                          $event.preventDefault();
                          return _vm.handleArrowRight(i, j);
                        },
                      ],
                    },
                  },
      ...
      _vm._l(_vm.list, function (item) {
        return _c(
          'div',
          {
            ...
            attrs: {
              tabindex: _vm.isDisabled(item.value) ? '-1' : '0',
            },
            on: {
              click: function click($event) {
                  ...
                  _vm._b(
                    {
                      attrs: {
                        date: _vm.innerValue,
                        'is-disabled-time': _vm.isDisabled,
                        'get-classes': _vm.getClasses,
          ...
          [
            ...
            this.showClearIcon
              ? h(
                  'button',
                  {
                    class: ''.concat(prefixClass, '-button-clear'),
                    attrs: {
                      'aria-label': 'clear',
                    },
                    on: {
      ...
      return h(
        'div',
        {
          class: _defineProperty(
            _defineProperty(
              _defineProperty(
                _defineProperty({}, ''.concat(prefixClass, '-datepicker'), true),
